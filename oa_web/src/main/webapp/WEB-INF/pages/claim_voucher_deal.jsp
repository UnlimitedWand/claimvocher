                    ...
                    <div class="row">
                        ...
                        <div name="selectFor" class="col-md-8 row">
                            <form action="/claim_voucher/fuzzyQueryForDeal" style="display: inline" method="post" autocomplete="off">
                                ...
                                <label for="cause"  class="field prepend-icon mw140">
                                    <label for="cause"  class="field-icon">
                                        <i class="fa fa-jpy"></i>
                                    </label>
                                    <input type="text" id="cause" name="cause" class="gui-input"  placeholder="事由..." >
                                </label>
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1" style="text-align: center;">
                        ...
                        <tr class="">
                            ...
                            <th class="text-center hidden-xs">事由</th>
                            ...
                            <tr class="message-unread">
                                ...
                                <td>
                                    <c:if test="${sessionScope.employee.post==Contant.POST_STAFF}">
                                        <c:if test="${cv.status==Contant.CLAIMVOCHER_CREATED || cv.status==Contant.CLAIMVOCHER_BACK || cv.status==Contant.CLAIMVOCHER_UNPASSED}">
                                    ...
                                    <c:if test="${sessionScope.employee.post==Contant.POST_CAHIER}">
                                        <c:if test="${cv.status==Contant.CLAIMVOCHER_SUBMIT}">
...
<%--                                    </c:if>--%>
                                <c:if test="${sessionScope.employee.post==Contant.POST_FM}">
                                    <c:if test="${cv.status == Contant.CLAIMVOCHER_PASSED}">
