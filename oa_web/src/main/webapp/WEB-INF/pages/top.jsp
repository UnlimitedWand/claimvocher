...
<head>
    ...
    <script>
        window.onload=function () {
            var p = "/assets/img/avatars/" + document.getElementById("pc").textContent.charCodeAt(1)%7 + ".jpg";
            var imgs = document.getElementsByName("headicon");
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img name="headicon" src="" alt="avatar" class="mw30 br64">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#">
                            <img name="headicon" src="" class="img-responsive">
                        </a>
