                ...
                <form:form id="admin-form" name="addForm" action="/claim_voucher/update" modelAttribute="info">
                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div id="items">
                            ...
                            <div class="section row">
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].item" class="field prepend-icon">
                                        ...
                                        <form:select cssStyle="padding-left: 17%" path="items[${sta.index}].item" cssClass="gui-input" placeholder="报销类型..." items="${items}"/>
                                    </label>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="section row">
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].guahaoType" class="field prepend-icon">

                                        <form:input path="items[${sta.index}].guahaoType" cssClass="gui-input" placeholder="挂号类型..."/>
                                        <label for="items[${sta.index}].guahaoType" class="field-icon">
                                            <i class="fa fa-h-square"></i>
                                        </label>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].hospital" class="field prepend-icon">
                                        <form:input path="items[${sta.index}].hospital" cssClass="gui-input" placeholder="医院..."/>
                                        <label for="items[${sta.index}].hospital" class="field-icon">
                                            <i class="fa fa-hospital-o"></i>
                                        </label>
                                    </label>
                                </div>
                                <div class="col-md-5">
                                    <label for="items[${sta.index}].keshi" class="field prepend-icon">
                                        <form:input path="items[${sta.index}].keshi" cssClass="gui-input" placeholder="科室..." />
                                        <label for="items[${sta.index}].keshi" class="field-icon">
                                            <i class="fa fa-bed"></i>
                                        </label>
                                    </label>
                                </div>
                            ...
                            <div class="section row">
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].document" class="field prepend-icon">

                                        <form:input path="items[${sta.index}].document" cssClass="gui-input" placeholder="文件..."/>
                                        <label for="items[${sta.index}].document" class="field-icon">
